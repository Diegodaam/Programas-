...
public class JFrameLogin extends javax.swing.JFrame {
    ...
    public ListSubject list = new ListSubject();
    public ListTasks listT = new ListTasks();
    public ListExams listE = new ListExams();
    public PilaUsers pila = new PilaUsers();
    public ListQuestions listQ = new ListQuestions();


    
    
    public JFrameLogin(PilaUsers pilaUsers, NodoUsers user, ListSubject list, ListTasks listT, ListExams listE, ListQuestions listQ) {
        initComponents();
        ...
        ImageIcon img = new ImageIcon("C:\\Users\\Diego\\Documents\\NetBeansProjects\\EduPlanner\\src\\Recursor\\Cursores\\Cursor2.png");
        ...
        setIconImage(new ImageIcon("C:\\Users\\Diego\\Documents\\NetBeansProjects\\EduPlanner\\src\\Recursor\\LogotipoCirculo.png").getImage());
    ...
    private void initComponents() {
        ...
        jLabel4.setIcon(new javax.swing.ImageIcon("C:\\Users\\Diego\\Documents\\NetBeansProjects\\EduPlanner\\src\\Recursor\\LogotipoLetrasBlancas.png")); // NOI18N
    ...
    private void jButtonSignInActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonSignInActionPerformed
        if(jTextFieldUser.getText().isEmpty() || jPasswordFieldPasswoed.getText().isEmpty()){
            JOptionPane.showMessageDialog(this, "Coloca tus datos");
        }else{
        textName = jTextFieldUser.getText();
        textPassword = Integer.parseInt(new String(jPasswordFieldPasswoed.getPassword()));
        
        
            user = pila.check(textName, textPassword);
