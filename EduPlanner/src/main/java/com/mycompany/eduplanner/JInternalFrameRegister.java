...
public class JInternalFrameRegister extends javax.swing.JInternalFrame {
    ...
    private void jButtonRegisterActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonRegisterActionPerformed
        if(jTextFieldName.getText().isEmpty() || jTextFieldLastName.getText().isEmpty() || jTextFieldPassword.getText().isEmpty() || jScrollBar1.getValue() == 0
            ...
            pila1.push(name, lastName, age, gender, password);
